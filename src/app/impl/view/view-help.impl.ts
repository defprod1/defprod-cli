...
export async function viewHelpImpl(ctx: CliExecutionContext): Promise<void> {
    ...
    console.log('  /view story <id|name|#>    View a user story (by ID, name, or list number)');
    console.log('  /view area <id|name|#>     View an area (by ID, name, or list number)');
